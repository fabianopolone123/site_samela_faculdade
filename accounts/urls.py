...
urlpatterns = [
    ...
    path('cadastrar-campos/campos/<int:field_id>/reativar/', views.restore_topic_field_view, name='restore_topic_field'),
    path('cadastrar-campos/topicos/<int:topic_id>/migrar-campos/', views.migrate_topic_fields_view, name='migrate_topic_fields'),
